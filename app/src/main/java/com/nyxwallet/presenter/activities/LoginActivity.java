...
import static com.nyxwallet.R.color.white;
import static com.nyxwallet.tools.util.BRConstants.PLATFORM_ON;
import static com.nyxwallet.tools.util.BRConstants.SCANNER_REQUEST;
...
//                            AuthManager.getInstance().authSuccess(LoginActivity.this);
        ...
        NYXApp.addOnBackgroundedListener(new NYXApp.OnAppBackgrounded() {
            @Override
