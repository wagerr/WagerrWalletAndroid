...
import static com.biblepaywallet.R.color.white;
import static com.biblepaywallet.tools.util.BRConstants.PLATFORM_ON;
import static com.biblepaywallet.tools.util.BRConstants.SCANNER_REQUEST;
...
//                            AuthManager.getInstance().authSuccess(LoginActivity.this);
        ...
        BiblePayApp.addOnBackgroundedListener(new BiblePayApp.OnAppBackgrounded() {
            @Override
