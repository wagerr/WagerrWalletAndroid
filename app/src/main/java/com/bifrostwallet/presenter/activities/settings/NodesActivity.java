...
import com.bifrostwallet.tools.util.TrustedNode;
...
//    private TextView nodeLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BRSharedPrefs.putCurrentWalletIso(this, "FROST");
        ...
        switchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletBifrostManager wm = WalletBifrostManager.getInstance(NodesActivity.this);
    ...
    private void updateButtonText() {
        WalletBifrostManager wm = WalletBifrostManager.getInstance(this);
    ...
    private void createDialog() {
        ...
        mDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletBifrostManager wm = WalletBifrostManager.getInstance(app);
