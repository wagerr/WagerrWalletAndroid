...
//    private TextView nodeLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BRSharedPrefs.putCurrentWalletIso(this, "NYX");
        ...
        switchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletNYXManager wm = WalletNYXManager.getInstance(NodesActivity.this);
    ...
    private void updateButtonText() {
        WalletNYXManager wm = WalletNYXManager.getInstance(this);
    ...
    private void createDialog() {
        ...
        mDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletNYXManager wm = WalletNYXManager.getInstance(app);
