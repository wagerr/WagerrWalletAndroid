...
import com.digiwagewallet.presenter.activities.CurrencySettingsActivity;
...
import com.digiwagewallet.presenter.entities.BRSettingsItem;
...
import static com.digiwagewallet.R.layout.settings_list_item;
import static com.digiwagewallet.R.layout.settings_list_section;
...
*/
        items.add(new BRSettingsItem(getString(R.string.Settings_digiwage), "", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SettingsActivity.this, CurrencySettingsActivity.class);
                BRSharedPrefs.putCurrentWalletIso(app, "WAGE");//change the current wallet to the one they enter settings to
                startActivity(intent);
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));
