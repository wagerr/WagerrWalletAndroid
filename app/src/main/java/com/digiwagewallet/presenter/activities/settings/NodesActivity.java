...
//    private TextView nodeLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BRSharedPrefs.putCurrentWalletIso(this, "WAGE");
        ...
        switchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletDigiwageManager wm = WalletDigiwageManager.getInstance(NodesActivity.this);
    ...
    private void updateButtonText() {
        WalletDigiwageManager wm = WalletDigiwageManager.getInstance(this);
    ...
    private void createDialog() {
        ...
        mDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletDigiwageManager wm = WalletDigiwageManager.getInstance(app);
