...
public class FingerprintActivity extends BRActivity {
    ...
    private String getLimitText() {
        ...
        return String.format(getString(R.string.TouchIdSettings_spendingLimit), CurrencyUtils.getFormattedAmount(this, "FROST", amount), CurrencyUtils.getFormattedAmount(this, iso, curAmount));
    }
