...
import static com.digiwagewallet.R.color.white;
import static com.digiwagewallet.tools.util.BRConstants.PLATFORM_ON;
import static com.digiwagewallet.tools.util.BRConstants.SCANNER_REQUEST;
...
//                            AuthManager.getInstance().authSuccess(LoginActivity.this);
        ...
        DigiWageApp.addOnBackgroundedListener(new DigiWageApp.OnAppBackgrounded() {
            @Override
